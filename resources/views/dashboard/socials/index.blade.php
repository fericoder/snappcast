@extends('.dashboard.layouts.master',  ['title' => 'مدیریت شبکه های اجتماعی'])
                ...
                <div class="m-portlet__body">
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <tr>
                            ...
                            <th title="Field #2" data-field="Owner">شبکه اجتماعی</th>
                            <th title="Field #8" data-field="OrderDate">کپشن</th>
                            <th title="Field #3" data-field="Contact">تاریخ انتشار</th>
        ...
        $(document).on('click', '.button', function (e) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        type: "POST",
                        url: "{{url('dashboard/social/delete')}}",
                        data: {id: id},
