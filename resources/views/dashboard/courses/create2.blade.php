@extends('.dashboard.layouts.master',  ['title' => 'افزودن دوره آموزشی'])
                                        ...
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* نوع دوره
                                                        آموزشی: </label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <select class="form-control m-select2" id="m_select2_3"
                                                                name="type">
                                                            <option value="free">رایگان</option>
                                                            <option value="cost">پولی</option>
                                                        </select>
                                                    </div>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* قیمت دوره (هزار تومان) : </label>
                                                    <div class="col-xl-9 col-lg-9">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* عنوان دوره
                                                        آموزشی:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="text" name="title" class="form-control m-input"
                                                               placeholder="عنوان دوره آموزشی را وارد نمایید"
                                                               value="{{ old('title') }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group m-form__group row">
                                                    ...
                                                    <div class="col-xl-9 col-lg-9">
                                                        <textarea style="font-family: iranyekan" name="description"
                                                                  class="form-control m-input iranyekan" id="" cols="30"
                                                                  placeholder="توضیحات دوره آموزشی را وارد نمایید"
                                ...
                                <div class="m-wizard__form-step" id="m_wizard_form_step_3">
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">تصویر دوره آموزشی و دانلود یکجا</h3>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">* تصویر دوره
                                                        آموزشی:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                    ...
                                                    <label class="col-xl-3 col-lg-3 col-form-label"> زیپ
                                                        یکجا:</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        <input type="file" name="allEpisodes" value="{{ old('allEpisodes') }}"
                                                               class="custom-file-input" id="allEpisodes">
                                                        <label class="custom-file-label" for="allEpisodes">انتخاب
                                                            فایل</label>
                                                    </div>
                                                    <br><br><span style="font-family: iranyekan;margin-top: 30px;">درصورتی که دوره تکمیل شده است، فایل زیپ تکمیل شده را آپلود کنید.</span>
                                                </div>
                                ...
                                <div class="m-wizard__form-step" id="m_wizard_form_step_4">
                                    <div class="row">
                                        <div class="col-xl-8 offset-xl-2">
                                            <div class="m-form__section m-form__section--first">
                                                <div class="m-form__heading">
                                                    <h3 class="m-form__heading-title">متن دوره آموزشی</h3>
                                                </div>

                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-12">
                                                        <label class="form-control-label">* متن دوره آموزشی:</label>
                                                        <textarea style="direction: rtl" {{ old('body') }} id="body"
                                                                  name="body"
                                                                  rows="18"></textarea>
                                                    </div>
                                                </div>
                                ...
                                <div class="m-form__actions m-form__actions">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 m--align-right">
                                            ...
                                            <button type="submit"
                                                    class="btn btn-success m-btn m-btn--custom m-btn--icon">ثبت دوره
                                                آموزشی جدید
                                            </button>
                                        </div>
                                        <div class="col-lg-2"></div>
